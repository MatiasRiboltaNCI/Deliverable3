...
public class UserInterface {
    ...
    if (data != null) {
        ...
        // Providing context by comparing with average or expected values
...
private void printVisualRepresentation(String dataType, float dataValue, float scale) {
    // Scale down the value for a reasonable length of the visual representation
    ...
    public void linkToArticle() {
        // Placeholder for linking to an article - in a real scenario, integrate with a web service or database
